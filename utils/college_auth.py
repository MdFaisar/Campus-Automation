    ...
    def validate_college_email(self, email: str, user_type: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if user_type.lower() == 'student':
                ...
                if username.startswith(self.student_prefix):
                    return {'valid': False, 'error': 'Faculty emails cannot start with student prefix'}
            ...
            <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
                    <div style="text-align: center; margin-bottom: 30px;">
                        ...
                        <p style="color: #7f8c8d; margin: 0;">Sri Muthukumaran Institute of Technology</p>
                    </div>
